...
7. **Spec review loop** — dispatch spec-document-reviewer subagent with precisely crafted review context; fix issues and re-dispatch until approved (max 5 iterations, then surface to human)
